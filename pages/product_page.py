...
class ProductPage(BasePage):
    ...
    def success_add_message_should_be_present(self):
        assert self.is_element_present(
            *ProductPageLocators.SUCCESS_ADD_MESSAGE), "Success add message is not presented"
    ...
    def should_be_product_name_in_cart(self):
        ...
        product_name_in_cart = self.browser.find_element(
            *ProductPageLocators.PRODUCT_NAME_IN_CART).text
    ...
    def cart_total_should_equal_product_price(self):
        ...
        cart_total = self.browser.find_element(
